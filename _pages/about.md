...
<div style="display: flex; align-items: top;">
    <img src="../images/uwmadison.png" alt="University Logo" style="width: 50px; height: 50px; margin-right: 10px;">
    <div style="flex-grow: 1;">
        <strong>University of Wisconsin–Madison</strong>, Madison, WI, USA
        <span style="font-size: smaller; display: block;">Ph.D. in Computer Sciences</span>
    </div>
    <div>
...
<div style="display: flex; align-items: top;">
    <img src="../images/kaist.png" alt="KAIST Logo" style="width: 50px; height: 50px; margin-right: 10px;">
    <div style="flex-grow: 1;">
...
<div style="display: flex; align-items: top;">
    <img src="../images/yonsei.png" alt="Yonsei Logo" style="width: 50px; height: 50px; margin-right: 10px;">
    <div style="flex-grow: 1;">
